...
// person can pick -- keep it in sync with the identical file in kittymae-pos (no
// shared asset pipeline between the two GitHub Pages repos, so each app keeps its
// own copy, same as every other shared-but-duplicated file in this codebase).
