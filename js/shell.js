...
import { requireSession, linkEmployee, getMyJobTitle, signOut, updateMyName } from './auth.js?v=20260922g';
import { listMyPermissions } from './api.js?v=20260922g';
import { initActivityFeed } from './activityFeed.js?v=20260922g';
