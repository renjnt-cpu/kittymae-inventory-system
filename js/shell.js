...
import { requireSession, linkEmployee, getMyJobTitle, signOut, updateMyName } from './auth.js?v=20260923b';
import { listMyPermissions } from './api.js?v=20260923b';
import { initActivityFeed } from './activityFeed.js?v=20260923b';
